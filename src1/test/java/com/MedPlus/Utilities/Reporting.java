...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext)
	{
		...
		//htmlReporter.loadXMLConfig("D:/pavanoltraining/test-output/extent-config.xml");
		...
		extent.setSystemInfo("user","SoftwareBees");
		
		htmlReporter.config().setDocumentTitle("MedPlus Hybrid Framework"); // Tile of report
